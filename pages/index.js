    ...
    <>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-center max-w-xl mb-8 text-gray-600">
          ...
          <br /><br />
          棋力や好きな棋士、棋風などを自由に記載して、あなたの囲碁スタイルを共有しましょう！
          <br /><br />
          まずは作成ボタンをクリックして名刺の情報を入力して登録して下さい。Googleでのログインが必要で、ユーザー名のみ入力必須です。
          <br /><br />
          編集ボタンをクリックすると編集ができ、ユーザー名で検索して名刺(自身のものを含む)を表示することも可能です。
          <br /><br />
          ※ユーザーリストのページを作成したり、棋力でユーザーを検索する機能を追加したりする予定です。
        </p>
